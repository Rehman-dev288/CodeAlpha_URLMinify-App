...
const API = "https://codealpha-urlminify-app.onrender.com/api";
...
const HomePage = () => {
  ...
  const shortUrl = shortenedUrl
    ? `${BACKEND_URL}/${shortenedUrl.shortCode}`
    : "";
        ...
        <div className="min-h-screen flex flex-col items-center justify-center px-6 md:px-12">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground font-inter max-w-2xl mx-auto">
              Transform long, complex URLs into sharp, precise links. Track
          ...
          <GlassCard className="w-full max-w-4xl p-8 md:p-12">
            <form onSubmit={handleShorten} className="space-y-6">
              <div>
                <label className="block text-sm font-medium mb-2 text-white/80 font-inter">
                  Long URL
                </label>
                <input
                  type="url"
            ...
            <AnimatePresence>
              {shortenedUrl && (
                ...
                >
                  <p className="text-sm text-white/60 mb-2 font-inter">
                    Your shortened URL:
                  </p>
      ...
      <div className="relative z-10 px-6 md:px-12 py-12">
          ...
          <GlassCard className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p
                  className="text-3xl font-bold text-white font-manrope"
                  data-testid="total-urls-stat"
                >
                  {totalUrls}
                </p>
              </div>
        ...
        {urls.length > 0 && (
          <GlassCard className="p-8 mb-12">
            <h2 className="text-2xl font-bold text-white mb-6 font-manrope">
              Click Performance
            </h2>
            ...
            urls.map((url) => {
              ...
              return (
                <GlassCard
                  ...
                  className="p-6"
                  hover
                  data-testid={`url-card-${url.shortCode}`}
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-3">
                        <code
                          className="text-brand-indigo font-mono text-lg font-bold"
                          data-testid={`short-code-${url.shortCode}`}
                        >
                          {url.shortCode}
                        </code>
                        <button
                      ...
                      <p
                        className="text-white/80 font-inter mb-3 truncate"
                        title={url.longUrl}
                      >
                        {url.longUrl}
                      </p>
                      <div className="flex items-center gap-6 text-sm text-white/50 font-inter">
                        ...
                        {url.last_clicked && (
                          <span>
                            Last clicked{" "}
                            {new Date(url.last_clicked).toLocaleDateString()}
                          </span>
                        )}
                      </div>
                    </div>
